...
-- 创建数据库
CREATE DATABASE IF NOT EXISTS `sharding_databases_tables_0`;
USE `sharding_databases_tables_0`;
...
-- 创建数据库
CREATE DATABASE IF NOT EXISTS `sharding_databases_tables_1`;
USE `sharding_databases_tables_1`;
