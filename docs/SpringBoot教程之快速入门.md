...
- [2. Spring Boot 系统要求](#2-spring-boot-系统要求)
- [3. 部署第一个 Spring Boot 项目](#3-部署第一个-spring-boot-项目)
  - [3.1. 环境检查](#31-环境检查)
  - [3.2. 创建 pom](#32-创建-pom)
  - [3.3. 添加依赖](#33-添加依赖)
  - [3.4. 编写代码](#34-编写代码)
  - [3.5. 运行示例](#35-运行示例)
  - [3.6. 创建可执行 jar](#36-创建可执行-jar)
- [4. 通过 SPRING INITIALIZR 创建 Spring Boot 项目](#4-通过-spring-initializr-创建-spring-boot-项目)
  - [4.1. 创建项目](#41-创建项目)
  - [4.2. 项目说明](#42-项目说明)
  - [4.3. 编写 REST 服务](#43-编写-rest-服务)
  - [4.4. 编写单元测试用例](#44-编写单元测试用例)
  - [4.5. 示例源码](#45-示例源码)
- [5. 参考资料](#5-参考资料)
...
## 4. 通过 SPRING INITIALIZR 创建 Spring Boot 项目
