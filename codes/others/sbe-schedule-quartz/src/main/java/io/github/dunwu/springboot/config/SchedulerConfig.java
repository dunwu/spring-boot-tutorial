...
import io.github.dunwu.springboot.job.SampleJob;
import io.github.dunwu.springboot.spring.AutowiringSpringBeanJobFactory;
...
public class SchedulerConfig {
    ...
    public Scheduler schedulerFactoryBean(DataSource dataSource, JobFactory jobFactory,
        ...
        scheduler.scheduleJob((JobDetail) sampleJobTrigger.getJobDataMap()
                                                          .get("jobDetail"), sampleJobTrigger);
        scheduler.start();
        return scheduler;
    }
